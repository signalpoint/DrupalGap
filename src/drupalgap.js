...
function drupalgap_init() {
    var dg = {
      ...
      views: {
        ids: [],
        templates: { } /* holds onto angular view templates, per entity type, per bundle */
      },
      views_datasource: {}
    };
  ...
  try {
    ...
    if (!drupalgap.online) {
      ...
      if (!proceed) {
        ...
        // therefore all of system connect goodies won't be available on the
        // first page until we do something about this...
