...
date_formats:{},date_types:{},entity_info:{},field_info_fields:{},field_info_instances:{},field_info_extra_fields:{},form_errors:{},form_states:[],loading:!1,loader:"loading",messages:[],menus:{},menu_links:{},menu_router:{},mvc:{models:{},views:{},controllers:{}},output:"",page:{jqm_events:[],title:"",variables:{},process:!0,options:{}},pages:[],path:"",remote_addr:null,router_path:"",services:{},sessid:null,settings:{},site_settings:{},taxonomy_vocabularies:!1,theme_path:"",themes:[],theme_registry:{},
views:{ids:[]},views_datasource:{}}}
...
function drupalgap_confirm(a,b){try{var c=null;b&&(c=b);var d=function(a){},f="Confirm",e=["OK","Cancel"];c&&(c.confirmCallback&&(d=c.confirmCallback),c.title&&(f=c.title),c.buttonLabels&&(e=c.buttonLabels));"function"===typeof parent.window.ripple||"web-app"==drupalgap.settings.mode?1==confirm(a)?d(1):d(2):navigator.notification.confirm(a,d,f,e);return!1}catch(g){console.log("drupalgap_confirm - "+g)}}
function drupalgap_toast(a,b,c){try{var d=b?b:420;setInterval(function(){$.mobile.loading("show",{textVisible:!0,html:a});setInterval(function(){$.mobile.loading().hide()},d)},c?c:1)}catch(f){console.log("drupalgap_toast - "+f)}}function drupalgap_load_blocks(){try{drupalgap.blocks=module_invoke_all("block_info")}catch(a){console.log("drupalgap_load_blocks - "+a)}}
...
function _theme_autocomplete(a,b,c,d){try{var f=_theme_autocomplete_variables[d];if("undefined"===typeof f.filter)console.log('_theme_autocomplete - A "filter" was not supplied.');else{var e="undefined"!==typeof f.value?!0:!1,g="undefined"!==typeof f.label?!0:!1;if(e||g){e?g||(f.label=f.value):f.value=f.label;var h=$(a),k=$(c.input).val(),m="";h.html("");if(k&&0<k.length)switch(h.html('<li><div class="ui-loader"><span class="ui-icon ui-icon-loading"></span></div></li>'),h.listview("refresh"),_theme_autocomplete_success_handlers[d]=
function(a,b,c,d){try{if(0==b.length){if(f.empty_callback){var e=window[f.empty_callback];e(k)}}else{var g=[],n=f.value,p=f.label;$.each(b,function(a,b){var f=null,f=c?b[d]:b;g.push({value:f[n],label:f[p]})});if(0!=g.length){f.items=g;var q=_theme_autocomplete_prepare_items(f);$.each(q,function(a,b){m+="<li>"+b+"</li>"});h.html(m);h.listview("refresh");h.trigger("updatelayout")}}f.finish_callback&&(e=window[f.finish_callback],e(k))}catch(s){console.log("_theme_autocomplete_success_handlers["+a+"] - "+
s)}},a=null,a=f.custom?f.handler?f.handler:"views":f.field_info_field.settings.handler,a){case "views":case "og":var n=f.path+"?"+f.filter+"="+encodeURIComponent(k);f.params&&(n+="&"+f.params);views_datasource_get_view_result(n,{success:function(a){var b=!0;f.custom&&(b=!1);var c=null,c=b?a[a.view.root]:a;(0,_theme_autocomplete_success_handlers[d])(d,c,b,a.view.child)}});break;case "base":var p=f.field_info_field.settings,q=p.target_type+"_index";if(!drupalgap_function_exists(q)){console.log("WARNING - _theme_autocomplete - "+
q+"() does not exist!");break}var r={fields:["nid","title"],parameters:{title:"%"+k+"%"},parameters_op:{title:"like"}};$.each(p.handler_settings.target_bundles,function(a,b){r.parameters.type=a;return!1});var s=window[q];s(r,{success:function(a){(0,_theme_autocomplete_success_handlers[d])(d,a,!1)}});break;case "index":if(!f.entity_type){console.log("WARNING - _theme_autocomplete - no entity_type provided");break}s=window[f.entity_type+"_index"];n=null;if(f.query)n=f.query;else{n={parameters:{},parameters_op:{}};
p=[];switch(f.entity_type){case "node":p=["nid","title"];break;case "taxonomy_term":p=["tid","name"],f.vid&&(n.parameters.vid=f.vid)}n.fields=p;n.parameters[f.filter]="%"+k+"%";n.parameters_op[f.filter]="like"}s.apply(null,[n,{success:function(a){(0,_theme_autocomplete_success_handlers[d])(d,a,!1,null)}}]);break;default:a||console.log("WARNING - _theme_autocomplete - no handler provided")}}else console.log('_theme_autocomplete - A "value" and/or "label" was not supplied.')}}catch(t){console.log("_theme_autocomplete - "+
t)}}function _theme_autocomplete_prepare_items(a){try{var b=[];a.items&&(b=a.items);var c=[];0<b.length&&$.each(b,function(b,d){var g="",h="";"string"===typeof d?h=g=d:(g=d.value,h=d.label);g=l(h,null,{attributes:{value:g,onclick:"_theme_autocomplete_click('"+a.attributes.id+"', this, '"+a.autocomplete_id+"')"}});c.push(g)});return c}catch(d){console.log("_theme_autocomplete_prepare_items - "+d)}}
...
f)}}function drupalgap_block_load(a){try{var b=null;drupalgap.blocks&&$.each(drupalgap.blocks,function(c,f){if(f[a])return b=f[a],!1});null==b&&drupalgap_alert('drupalgap_block_load - failed to load "'+a+'" block!');return b}catch(c){console.log("drupalgap_block_load - "+c)}}
function drupalgap_block_render(a,b,c,d,f){try{var e="",g=!1;d.access_callback&&drupalgap_function_exists(d.access_callback)?g=(0,window[d.access_callback])({path:b,delta:c,region:a.name,theme:drupalgap.settings.theme,settings:d}):drupalgap_check_visibility("block",d)&&(g=!0,"main"==c||"offline"!=b&&"error"!=b||(g=!1));if(g){var h=drupalgap_block_load(c);f&&f.block_count++;menu_load(c)&&f&&f.block_menu_count++;h&&(e=module_invoke(h.module,"block_view",c,a))}return e}catch(k){console.log("drupalgap_block_render - "+
k)}}function drupalgap_attributes(a){try{var b="";a&&$.each(a,function(a,c){b=""!=c?b+(a+'="'+c+'" '):b+(a+" ")});return b}catch(c){console.log("drupalgap_attributes - "+c)}}
...
function drupalgap_get_path(a,b){try{var c=null;if("module"==a){var d=!1;$.each(Drupal.modules,function(a,f){if(d)return!1;$.each(f,function(f,g){if(g.name==b){d=!0;c="";if("core"==a)c+="modules";else if("contrib"==a)c+="app/modules";else if("custom"==a)c+="app/modules/custom";else return drupalgap_alert("drupalgap_get_path - unknown module bundle ("+a+")"),!1;c+="/"+b;return!1}})})}else"theme"==a?c="easystreet3"==b||"ava"==b?"themes/"+b:"app/themes/"+b:console.log("WARNING: drupalgap_get_path - unsupported type ("+
a+")");return c}catch(f){console.log("drupalgap_get_path - "+f)}}function drupalgap_error(a){try{var b="drupalgap_error() - "+arguments.callee.caller.name+" - "+a;dpm(b);Drupal.settings.debug&&drupalgap_alert(b);arguments[1]&&drupalgap_alert(arguments[1]);"error"!=drupalgap_path_get()&&drupalgap_goto("error")}catch(c){console.log("drupalgap_error - "+c)}}
...
function _drupalgap_form_state_values_assemble_get_element_value(a,b){try{if(b.value_callback&&function_exists(b.value_callback))return(0,window[b.value_callback])(a,b);var c=null,d="",d="radios"==b.type?'input:radio[name="'+a+'"]:checked':"#"+a;switch(b.type){case "checkbox":var f=$(d),c=$(f).is(":checked")?1:0;break;case "checkboxes":var c={},e=$('label[for="'+a+'"]').siblings(".ui-checkbox");$.each(e,function(a,b){var d=$(b).children("input"),e=$(d).attr("value");$(d).is(":checked")?c[e]=e:c[e]=
0});break;case "list_boolean":f=$(d),c=$(f).is(":checked")?$(f).attr("on"):$(f).attr("off")}null===c&&(c=$(d).val());"undefined"===typeof c&&(c=null);return c}catch(g){console.log("_drupalgap_form_state_values_assemble_get_element_value - "+g)}}
function drupalgap_get_form(a){try{var b="",c=drupalgap_form_load.apply(null,Array.prototype.slice.call(arguments));c?b=drupalgap_form_render(c):drupalgap_alert("drupalgap_get_form - failed to get form ("+a+")");return b}catch(d){console.log("drupalgap_get_form - "+d)}}
...
""),c.attributes["class"]+=" dg_form_submit_button ");$.extend(!0,c,d);"undefined"!==typeof c.value&&null!=c.value||"undefined"===typeof d.default_value||(c.value=d.default_value);if(drupalgap_function_exists("theme_"+e))f+=theme(e,c);else if(d.markup||""==d.markup)f+=d.markup;else return console.log("WARNING: _drupalgap_form_render_element_item() - "+("Field "+d.type+" not supported.")),dpm(d),null;if(d.children&&0<d.children.length)for(a=0;a<d.children.length;a++)if(d.children[a].markup)f+=d.children[a].markup;
else if(d.children[a].type||d.children[a].theme){var g=d.children[a].type;g||(g=d.children[a].theme);d.children[a].title&&(f+=theme("form_element_label",{element:d.children[a]}));d.children[a].prefix&&(f+=d.children[a].prefix);f+=theme(g,d.children[a]);d.children[a].suffix&&(f+=d.children[a].suffix)}else console.log("WARNING: _drupalgap_form_render_element_item - failed to render child "+a+" for "+b.name);return f}catch(h){console.log("_drupalgap_form_render_element_item - "+h)}}
...
c)}}function drupalgap_form_onkeypress(a){try{var b=window.event;if("13"==(b.which||b.keyCode))return $("#"+a+" button.dg_form_submit_button").click(),b.preventDefault(),!1}catch(c){console.log("drupalgap_form_onkeypress - "+c)}}function theme_checkbox(a){try{return a.attributes.type="checkbox",a.checked&&(a.attributes.checked="checked"),"<input "+drupalgap_attributes(a.attributes)+" />"}catch(b){console.log("theme_checkbox - "+b)}}
function theme_checkboxes(a){try{var b="";a.attributes.type="checkboxes";$.each(a.options,function(c,f){if("attributes"!=c){empty(f);var e={value:c,attributes:{name:a.name+"["+c+"]","class":a.name,value:c}};a.value&&a.value[c]&&(e.checked=!0);b+="<label>"+theme("checkbox",e)+"&nbsp;"+f+"</label>"}});return b}catch(c){console.log("theme_checkbox - "+c)}}
...
function theme_textfield(a){try{return a.attributes.type="text","<input "+drupalgap_attributes(a.attributes)+" />"}catch(b){console.log("theme_textfield - "+b)}}function theme_textarea(a){try{return"<div><textarea "+drupalgap_attributes(a.attributes)+">"+a.value+"</textarea></div>"}catch(b){console.log("theme_textarea - "+b)}}var _drupalgap_goto_query_string=null;
...
"MENU_LOCAL_TASK"==drupalgap.menu_links[d].type||drupalgap_menu_access(d)||(a="401",d=drupalgap_get_menu_link_router_path(a));if(d==drupalgap_router_path_get()&&a==drupalgap_path_get()&&!c.form_submission)if(c.reloadPage)_system_reload_page=a,a="_reload",d=drupalgap_get_menu_link_router_path(a);else return!1;var g=drupalgap_get_page_id(a);if(drupalgap_jqm_active_page_url()==g&&c.form_submission)return drupalgap_clear_messages(),!1;in_array(drupalgap_path_get())||drupalgap.back_path.push(drupalgap_path_get());
drupalgap_path_set(a);drupalgap_router_path_set(d);if(drupalgap_page_in_dom(g))if(drupalgap.menu_links[d].options&&(c=$.extend({},drupalgap.menu_links[d].options,c)),"undefined"!==typeof c.reloadPage&&c.reloadPage)drupalgap_remove_page_from_dom(g,{force:!0,leaveQuery:_drupalgap_goto_query_string?!0:!1}),delete c.reloadPage,c.reloadingPage=!0;else{if(!c.form_submission){drupalgap_clear_messages();_drupalgap_goto_query_string=null;drupalgap.page.process=!1;$.mobile.changePage("#"+g,c);module_invoke_all("drupalgap_goto_post_process",
a);return}}else"undefined"!==typeof c.reloadPage&&c.reloadPage&&delete c.reloadPage;drupalgap_goto_generate_page_and_go(a,g,c,drupalgap.menu_links[d])}catch(h){console.log("drupalgap_goto - "+h)}}
function drupalgap_goto_generate_page_and_go(a,b,c,d){try{var f=path_to_theme()+"/page.tpl.html";if(drupalgap_file_exists(f)){_drupalgap_goto_query_string=null;"undefined"===typeof c&&(c={});var e={};drupalgap.settings.cache&&"undefined"!==drupalgap.settings.cache.theme_registry&&!drupalgap.settings.cache.theme_registry&&(e.cache=!1);var g=drupalgap_file_get_contents(f,e);if(g){drupalgap_add_page_to_dom({page_id:b,html:g,menu_link:d});drupalgap_path_get()==a&&c.form_submission&&(c.allowSamePageTransition=
...
function _drupalgap_goto_prepare_path(a,b){try{if("undefined"!==typeof b&&b){var c=a.indexOf("?");if(-1!=c&&c!=a.length-1){var d=a.substr(c+1,a.length-c);_drupalgap_goto_query_string=d;a=a.substr(0,c);for(var f=d.split("&"),e=0;e<f.length;e++)c=f[e].indexOf("="),-1!=c&&(d=f[e].split("="),2==d.length&&_GET(decodeURIComponent(d[0]),decodeURIComponent(d[1]),a))}}if(""==a)if(drupalgap.settings.front)a=drupalgap.settings.front;else return drupalgap_alert("drupalgap_goto_prepare_path - no front page specified in settings.js!"),
!1;else"user"==a&&(a=0!=Drupal.user.uid?"user/"+Drupal.user.uid:"user/login");return a}catch(g){console.log("drupalgap_goto_prepare_path - "+g)}}function drupalgap_back(){try{if($(".ui-page-active").attr("id")==drupalgap.settings.front){var a="Exit "+drupalgap.settings.title+"?";drupalgap.settings.exit_message&&(a=drupalgap.settings.exit_message);drupalgap_confirm(a,{confirmCallback:_drupalgap_back_exit})}else _drupalgap_back()}catch(b){console.log("drupalgap_back"+b)}}
...
$(window).on("navigate",function(a,b){"web-app"==drupalgap.settings.mode&&"back"==b.state.direction&&0<drupalgap.back_path.length&&(drupalgap.back=!0,drupalgap_path_set(drupalgap.back_path[drupalgap.back_path.length-1]),drupalgap_router_path_set(drupalgap_get_menu_link_router_path(drupalgap_path_get())))});
function _GET(a,b,c){try{var d=!1,f=!1,e=null,g=null;if("undefined"!==typeof b)if(f=!0,g=b,"undefined"!==typeof a)e=a;else return console.log("WARNING: _GET - missing key for value ("+g+")"),null;else"undefined"!==typeof a?(d=!0,e=a):d=!0;if(d){var h=null,h="undefined"!==typeof c?c:drupalgap_get_page_id();if("undefined"!==typeof _dg_GET[h]){if(!e)return _dg_GET[h];if("undefined"!==typeof _dg_GET[h][e])return _dg_GET[h][e]}}else f&&(h=null,h="undefined"!==typeof c?drupalgap_get_page_id(c):drupalgap_get_page_id(),
"undefined"===typeof _dg_GET[h]&&(_dg_GET[h]={}),g&&(_dg_GET[h][e]=g));return null}catch(k){console.log("_GET - "+k)}}
...
function template_process_page(a){try{var b=drupalgap_path_get();drupalgap.output=menu_execute_active_handler();var c=drupalgap_get_page_id(b),d=$("#"+c).html();d&&($.each(drupalgap.theme.regions,function(a,b){d=d.replace("{:"+b.name+":}",drupalgap_render_region(b))}),$("#"+c).html(d))}catch(f){console.log("template_process_page - "+f)}}
...
function drupalgap_remove_page_from_dom(a,b,c){try{var d=null,d="undefined"!==typeof c?c:drupalgap_get_page_id(drupalgap_path_get());c={};"undefined"!==typeof b&&(c=b);d!=a||c.force?($("#"+a).empty().remove(),delete drupalgap.pages[a],"undefined"===typeof _dg_GET[a]||"undefined"!==typeof c.leaveQuery&&c.leaveQuery||delete _dg_GET[a]):console.log("WARNING: drupalgap_remove_page_from_dom() - not removing the current page ("+a+") from the DOM!")}catch(f){console.log("drupalgap_remove_page_from_dom - "+
f)}}function drupalgap_remove_pages_from_dom(){try{var a=drupalgap_get_page_id(drupalgap_path_get());$.each(drupalgap.pages,function(b,d){a!=d&&drupalgap_remove_page_from_dom(d,null,a)});drupalgap.pages=[a];drupalgap.views.ids=[];drupalgap.page.jqm_events=[];drupalgap.back_path=[]}catch(b){console.log("drupalgap_remove_pages_from_dom - "+b)}}
function drupalgap_page_class_get(a){try{for(var b=a.replace(/[\/%]/g,"_");b.lastIndexOf("_")==b.length-1;)b=b.substr(0,b.length-1);return b}catch(c){console.log("drupalgap_page_class_get - "+c)}}function drupalgap_page_in_dom(a){try{var b=$("body div[data-role$='page']"),c=!1;b&&0<b.length&&$.each(b,function(b,d){if($(d).attr("id")==a)return c=!0,!1});return c}catch(d){console.log("drupalgap_page_in_dom - "+d)}}
...
drupalgap_attributes(a.attributes)+">"),d=0,f=0;if(a.links&&0<a.links.length){var e=0,g=0;$.each(a.links,function(a,b){var c=menu_region_link_get_data(b);drupalgap_check_visibility("region",c)&&(d++,c=drupalgap_link_get_class(b))&&(c=menu_region_link_get_side(c),"left"==c?e++:"right"==c&&g++)});for(var h="",k="",m=0;m<a.links.length;m++){var n=a.links[m],p=menu_region_link_get_data(n);if(drupalgap_check_visibility("region",p)&&!in_array(b,["offline","error","user/logout"])){var q=n.title,r=n.path;
p.options.popup?(f++,q&&!empty(q)||"undefined"!==typeof p.options.attributes["data-iconpos"]||(p.options.attributes["data-iconpos"]="notext"),"undefined"===typeof p.options.attributes["data-rel"]&&(p.options.attributes["data-rel"]="popup"),"undefined"===typeof p.options.attributes["data-icon"]&&(p.options.attributes["data-icon"]="bars"),"undefined"===typeof p.options.attributes["data-role"]&&(p.options.attributes["data-role"]="button"),r=null,p.options.attributes.href="#"+menu_container_id(p.options.popup_delta)):
"undefined"===typeof p.options.attributes["data-role"]&&(p.options.attributes["data-role"]="button");"notext"==p.options.attributes["data-iconpos"]&&(q="&nbsp;");var s=drupalgap_link_get_class(n),t=menu_region_link_get_side(s),v=l(q,r,p.options);"left"==t?h+=v:"right"==t&&(k+=v)}}if(1<e)var w={"data-type":"horizontal","data-role":"controlgroup","class":"ui-btn-left"},h="<div "+drupalgap_attributes(w)+">"+h.replace(/ui-btn-left/g,"")+"</div>";1<g&&(w={"data-type":"horizontal","data-role":"controlgroup",
"class":"ui-btn-right"},k="<div "+drupalgap_attributes(w)+">"+k.replace(/ui-btn-right/g,"")+"</div>");c+=h+k}var u={block_count:0,block_menu_count:0};$.each(drupalgap.settings.blocks[drupalgap.settings.theme][a.name],function(d,e){"_prefix"!=d&&"_suffix"!=d&&(c+=drupalgap_block_render(a,b,d,e,u))});if(in_array(a.attributes["data-role"],["header","footer"])&&(0==u.block_count&&0<d||0==u.block_count-u.block_menu_count)||0<d&&f>=u.block_menu_count&&0==u.block_count)if("undefined"===typeof a.collapse_on_empty||
!1===a.collapse_on_empty)c+="<h2>&nbsp;</h2>";c+="</div>\x3c!-- "+a.name+" --\x3e"}return c+=_drupalgap_region_render_zone("_suffix",a,b)}catch(x){console.log("drupalgap_render_region - "+x)}}function _drupalgap_region_render_zone(a,b,c){try{var d="",f=drupalgap.settings.blocks[drupalgap.settings.theme][b.name];if("undefined"===typeof f[a])return d;$.each(f[a],function(a,e){d+=drupalgap_block_render(b,c,a,e)});return d}catch(e){console.log("_drupalgap_region_render_zone - "+e)}}
function drupalgap_panel_id(a){try{return a+"_"+drupalgap_get_page_id()}catch(b){console.log("drupalgap_panel_id - "+b)}}
...
(drupalgap.menu_links[d].siblings=[]),drupalgap.menu_links[d].siblings.push(a),b.siblings.push(d))}))}}catch(f){console.log("drupalgap_menu_router_build_relationships - "+f)}}function path_to_theme(){try{if(drupalgap.theme_path)return drupalgap.theme_path;console.log("path_to_theme - drupalgap.theme_path is not set!");return!1}catch(a){console.log("path_to_theme - "+a)}}
...
function theme_link(a){try{var b="";a.text&&(b=a.text);if("undefined"!==typeof a.path&&null!=a.path){if(0==a.path.indexOf("#"))return a.attributes.href=a.path,"<a "+drupalgap_attributes(a.attributes)+">"+b+"</a>";var c="drupalgap_goto('"+a.path+"');";if(a.options)if(a.options.InAppBrowser)c="window.open('"+a.path+"', '_blank', 'location=yes');";else{a.path=_drupalgap_goto_prepare_path(a.path);var d="";$.each(a.options,function(a,b){"attributes"!=a&&("string"===typeof b&&(b="'"+b+"'"),d+=a+":"+b+",")});
c="drupalgap_goto('"+a.path+"', {"+d+"});"}a.path==drupalgap_path_get()&&(-1==a.attributes["class"].indexOf("ui-btn-active")&&(a.attributes["class"]+=" ui-btn-active "),-1==a.attributes["class"].indexOf("ui-state-persist")&&(a.attributes["class"]+=" ui-state-persist "));return'<a href="#" onclick="javascript:'+c+'"'+drupalgap_attributes(a.attributes)+">"+b+"</a>"}"undefined"===typeof a.attributes.href&&(a.attributes.href="#");return"<a "+drupalgap_attributes(a.attributes)+">"+b+"</a>"}catch(f){console.log("theme_link - "+
f)}}function theme_logout(a){try{return bl("Logout","user/logout",{attributes:{"data-icon":"action","data-iconpos":"right"}})}catch(b){console.log("theme_logout - "+b)}}function theme_popup(a){try{a.attributes["data-role"]="popup";var b={};a.button_attributes&&(b=a.button_attributes);b.href="#"+a.attributes.id;b["data-rel"]="popup";return bl(a.button_text,null,{attributes:b})+"<div "+drupalgap_attributes(a.attributes)+">"+a.content+"</div>"}catch(c){console.log("theme_popup - "+c)}}
function theme_submit(a){try{return"<button "+drupalgap_attributes(a.attributes)+">"+a.element.value+"</button>"}catch(b){console.log("theme_submit - "+b)}}
...
function comment_services_postprocess(a,b){try{if("comment"==a.service&&"create"==a.resource){var c=drupalgap_path_get();if("node/%"==drupalgap_get_menu_link_router_path(c)){var d=arg(1),f=comments_container_id(d),e=$("#"+f);"undefined"!==typeof e.length&&0==e.length||node_load(d,{reset:!0,success:function(a){comment_load(b.cid,{success:function(a){$(e).append(theme("comment",{comment:a})).trigger("create");scrollToElement("#"+f+" :last-child",500);a="#"+drupalgap_get_page_id()+" #comment_edit";drupalgap_form_clear(a)}})}})}}}catch(g){console.log("comment_services_postprocess - "+
...
'</h2><ul data-role="listview" data-inset="true"><li>'+e+"</li></ul>"+b.content;c+=a;if(user_access("administer comments")||user_access("edit own comments")&&b.uid==Drupal.user.uid)c+=theme("button_link",{text:"Edit",path:"comment/"+b.cid+"/edit",attributes:{"data-icon":"gear"}});return c+"</div>"}catch(g){console.log("theme_comment - "+g)}}
...
function drupalgap_entity_edit_form_delete_confirmation(a,b){try{drupalgap_confirm("Delete this content, are you sure? This action cannot be undone...",{confirmCallback:function(c){2!=c&&(drupalgap.loader="deleting",c=services_get_resource_function_for_entity(a,"delete"),(0,window[c])(b,{success:function(c){c=drupalgap_get_page_id(a+"/"+b);drupalgap_page_in_dom(c)&&drupalgap_remove_page_from_dom(c);window.localStorage.removeItem(entity_local_storage_key(a,b));c=drupalgap_form_local_storage_load("node_edit");
drupalgap_goto(c.action?c.action:"",{reloadPage:!0,form_submission:!0})}}))}})}catch(c){console.log("drupalgap_entity_edit_form_delete_confirmation - "+c)}}
...
b){return a-b});var h=[];$.each(g,function(c,g){$.each(f,function(c,f){if(g==f&&-1==h.indexOf(c))return h.push(c),b.content+=drupalgap_entity_render_field(a,b,c,d[c],e[c]),!1})});module_invoke_all("entity_post_render_content",b,a,c);_entity_local_storage_save(a,b[entity_primary_key(a)],b)}}catch(k){console.log("drupalgap_entity_render_content - "+k)}}
...
function number_field_widget_form(a,b,c,d,f,e,g,h){try{switch(h.type){case "number_integer":case "number_float":case "range":"range"!=h.type&&(e[g].type="number");empty(d.settings.max)||(e[g].options.attributes.min=d.settings.min);empty(d.settings.max)||(e[g].options.attributes.max=d.settings.max);a=1;"number_float"==h.type&&(a=.01);e[g].options.attributes.step=a;break;default:console.log("number_field_widget_form - element type not supported ("+h.type+")")}}catch(k){console.log("number_field_widget_form - "+
k)}}
...
function image_field_widget_form(a,b,c,d,f,e,g,h){try{e[g].type="hidden";"user_profile_form"==a.id&&"picture"==h.name&&(c={field_name:"picture"});if("undefined"!==typeof e[g].item&&e[g].item.fid){e[g].value=e[g].item.fid;var k=drupalgap_image_path(e[g].item.uri),m=theme("image",{path:k})+'<div class="filename">'+l(e[g].item.filename,k,{InAppBrowser:!0})+"</div>"}else{d="Take Photo";e[g].value&&(d=e[g].value);f="Browse";e[g].value2&&(f=e[g].value2);var n=e[g].id.replace(/-/g,"_");a=n+"_imagefield_source";
b=n+"_imagefield_destination_type";h=n+"_imagefield_data";eval("var "+a+" = null;");eval("var "+b+" = null;");eval("var "+h+" = null;");var p=e[g].id+"-browse-button",m='<div><div id="'+e[g].id+'-imagefield-msg"></div><img id="'+e[g].id+'-imagefield" style="display: none;" /><a href="#" data-role="button" data-icon="camera" id="'+e[g].id+'-button">'+d+'</a><a href="#" data-role="button" data-icon="grid" id="'+p+'">'+f+"</a></div>",m=m+'<script type="text/javascript">';d=n+"_imagefield_ready";m+='$("#'+
drupalgap_get_page_id(drupalgap_path_get())+'").on("pageshow",function(){document.addEventListener("deviceready", '+d+", false);});function "+d+"() {"+a+" = navigator.camera.PictureSourceType;"+b+" = navigator.camera.DestinationType;}";d=n+"_error";m+="function "+d+'(message) {if (message != "Camera cancelled." && message != "Selection cancelled." && message != "no image selected"){console.log("'+d+'");drupalgap_alert(message);}}';n+="_success";m+="function "+n+'(imageData) {_image_phonegap_camera_getPicture_success({field_name:"'+
c.field_name+'", image:imageData, id:"'+e[g].id+'"})}';c=50;drupalgap.settings.camera.quality&&(c=drupalgap.settings.camera.quality);m+='$("#'+e[g].id+'-button").on("click",function(){var photo_options = {quality: '+c+",destinationType: "+b+".DATA_URL,correctOrientation: true};navigator.camera.getPicture("+n+", "+d+", photo_options);});";m+='$("#'+p+'").on("click",function(){var browse_photo_options = {quality: '+c+",sourceType: "+a+".PHOTOLIBRARY,destinationType: "+b+".DATA_URL,correctOrientation: true};navigator.camera.getPicture("+
n+", "+d+", browse_photo_options);});";m+="\x3c/script>"}e[g].children.push({markup:m})}catch(q){console.log("image_field_widget_form - "+q)}}function _image_field_widget_form_remove_image(){try{alert("_image_field_widget_form_remove_image")}catch(a){console.log("_image_field_widget_form_remove_image - "+a)}}
function image_fields_present_on_entity_type(a,b){try{var c=[],d=drupalgap_field_info_instances(a,b);if(!d)return!1;$.each(d,function(a,b){b.widget&&b.widget.type&&"image_image"==b.widget.type&&c.push(a)});return 0==c.length?!1:c}catch(f){console.log("image_fields_present_on_entity_type - "+f)}}
...
function node_page_view_pageshow(a){try{node_load(a,{success:function(a){var b="node_page_view_alter_"+a.type,f=module_implements(b);if(0<f.length)1<f.length&&console.log("node_page_view_pageshow - WARNING - there is more than one module implementing hook_"+b+"(), we will use the first one: "+f[0]),(0,window[f[0]+"_"+b])(a,{success:function(b){_drupalgap_entity_page_container_inject("node",a.nid,"view",b)}});else{b=language_default();f=a.title;a.title_field&&a.title_field[b]&&(f=a.title_field[b][0].safe_value);
var e={theme:"node",node:a,title:{markup:f},content:{markup:a.content}};if("undefined"===typeof a.comment)_drupalgap_entity_page_container_inject("node",a.nid,"view",e);else if(0!=a.comment){if(1==a.comment||2==a.comment){var g="";2==a.comment&&(g=drupalgap_get_form("comment_edit",{nid:a.nid},a));0!=a.comment_count?comment_index({parameters:{nid:a.nid}},{success:function(b){try{var d="";$.each(b,function(a,b){d+=theme("comment",{comment:b})});e.content.markup+=theme("comments",{node:a,comments:d});
2==a.comment&&(e.content.markup+=g);_drupalgap_entity_page_container_inject("node",a.nid,"view",e)}catch(f){console.log("node_page_view_pageshow - comment_index - "+f)}}}):(2==a.comment&&(e.content.markup+=theme("comments",{node:a}),e.content.markup+=g),_drupalgap_entity_page_container_inject("node",a.nid,"view",e))}}else e.content.markup+=theme("comments",{node:a}),_drupalgap_entity_page_container_inject("node",a.nid,"view",e)}}})}catch(b){console.log("node_page_view_pageshow - "+b)}}
...
function search_menu(){return{"search/%/%":{title:"Search",page_callback:"drupalgap_get_form",pageshow:"search_form_pageshow",page_arguments:["search_form"],access_arguments:["search content"]}}}
...
function system_menu(){return{dashboard:{title:"Dashboard",page_callback:"system_dashboard_page"},error:{title:"Error",page_callback:"system_error_page"},offline:{title:"Offline",page_callback:"system_offline_page"},401:{title:"401 - Not Authorized",page_callback:"system_401_page"},404:{title:"404 - Not Found",page_callback:"system_404_page"},_reload:{title:"Reloading...",page_callback:"system_reload_page",pageshow:"system_reload_pageshow"}}}
function system_401_page(a){return"Sorry, you are not authorized to view this page."}function system_404_page(a){return"Sorry, the page you requested was not found."}function system_reload_page(){return""}function system_reload_pageshow(){try{drupalgap_loading_message_show()}catch(a){console.log("system_reload_pageshow - "+a)}}
...
function system_settings_form(a,b){try{return a.elements.submit||(a.elements.submit={type:"submit",value:"Save configuration"}),a.buttons.cancel||(a.buttons.cancel=drupalgap_form_cancel_button()),a.submit.push("system_settings_form_submit"),a}catch(c){console.log("system_settings_form - "+c)}}function system_settings_form_submit(a,b){try{b.values&&$.each(b.values,function(a,b){variable_set(a,b)})}catch(c){console.log("system_settings_form_submit - "+c)}}
...
function user_access(a,b){try{var c;c=b?b:Drupal.user;if(1==c.uid)return!0;var d=!1;$.each(c.permissions,function(b,c){if(c.permission==a)return d=!0,!1});return d}catch(f){console.log("user_access - "+f)}}function user_edit_access(a){try{return Drupal.user.uid==a.uid||user_access("administer users")?!0:!1}catch(b){console.log("user_edit_access - "+b)}}function user_listing(){return{user_listing:{theme:"jqm_item_list",title:"Users",items:[],attributes:{id:"user_listing_items"}}}}
function user_listing_pageshow(){try{views_datasource_get_view_result("drupalgap/views_datasource/drupalgap_users",{success:function(a){var c=[];$.each(a.users,function(a,b){c.push(l(b.user.name,"user/"+b.user.uid))});drupalgap_item_list_populate("#user_listing_items",c)}})}catch(a){console.log("user_listing_pageshow - "+a)}}function user_logout_callback(){return"<p>Logging out...</p>"}
function user_logout_pagechange(){try{user_logout({success:function(a){drupalgap_goto(drupalgap.settings.front)}})}catch(a){console.log("user_logout_pagechange - "+a)}}
...
access_arguments:["access user profiles"],pageshow:"user_listing_pageshow"},"user/password":{title:"Request new password",page_callback:"drupalgap_get_form",page_arguments:["user_pass_form"]}}}function user_page(){return"user_page()"}function user_register_access(){try{switch(drupalgap.site_settings.user_register){case "0":return!1;case "1":case "2":return!0}}catch(a){console.log("user_register_access - "+a)}}
...
function user_view_pageshow(a){try{user_load(a,{success:function(a,b,f){var e="full",g=null;b&&(e=b);f&&(g=f);g||(g=language_default());a&&(b={theme:"user_profile",account:a,view_mode:e,language:g,name:{markup:a.name},created:{markup:'<div class="user_profile_history"><h3>History</h3><dl><dt>Member since</td></dt><dd>'+(new Date(1E3*parseInt(a.created))).toDateString()+"</dd></div>"}},"undefined"!==typeof a.content&&(b.content={markup:a.content}),a.picture&&a.picture.fid&&(b.picture={theme:"image",
path:image_style_url(drupalgap.site_settings.user_picture_style,a.picture.uri)}),_drupalgap_entity_page_container_inject("user",a.uid,"view",b))}})}catch(b){console.log("user_view_pageshow - "+b)}}function user_view_title(a,b){try{user_load(b,{success:function(b){a.call(null,b.name)}})}catch(c){console.log("user_view_title - "+c)}}
function drupalgap_user_has_role(a,b){try{var c=!1,d=null,d=b?b:Drupal.user;$.each(d.roles,function(b,d){if(a==d)return c=!0,!1});return c}catch(f){console.log("drupalgap_user_has_role - "+f)}}
function user_login_form(a,b){try{return a.entity_type="user",a.bundle=null,a.elements.name={type:"textfield",title:"Username",title_placeholder:!0,required:!0},a.elements.pass={type:"password",title:"Password",title_placeholder:!0,required:!0,attributes:{onkeypress:"drupalgap_form_onkeypress('"+a.id+"')"}},a.elements.submit={type:"submit",value:"Login"},user_register_access()&&(a.buttons.create_new_account={title:"Create new account",attributes:{onclick:"drupalgap_goto('user/register')"}}),a.buttons.forgot_password=
{title:"Request new password",attributes:{onclick:"drupalgap_goto('user/password')"}},a}catch(c){console.log("user_login_form - "+c)}}function user_login_form_submit(a,b){try{user_login(b.values.name,b.values.pass,{success:function(a){drupalgap_goto(drupalgap.settings.front)}})}catch(c){console.log("user_login_form_submit - "+c)}}
...
function user_profile_form(a,b,c){try{return a.entity_type="user",a.bundle=null,drupalgap_entity_add_core_fields_to_form("user",null,a,c),drupalgap_field_info_instances_add_to_form("user",null,a,c),user_access("change own username")||(a.elements.name.access=!1,a.elements.name.required=!1),0==drupalgap.site_settings.user_pictures&&delete a.elements.picture,Drupal.user.uid==c.uid&&(a.elements.current_pass={title:"Current password",type:"password",description:"Enter your current password to change the E-mail address or Password."}),
a.elements.pass_pass1={title:"Password",type:"password"},a.elements.pass_pass2={title:"Confirm password",type:"password",description:"To change the current user password, enter the new password in both fields."},a.elements.submit={type:"submit",value:"Save"},a.buttons.cancel={title:"Cancel",attributes:{onclick:"javascript:drupalgap_back();"}},a}catch(d){console.log("user_profile_form - "+d)}}
function user_profile_form_validate(a,b){try{empty(b.values.current_pass)?!empty(b.values.current_pass)||empty(b.values.pass_pass1)||empty(b.values.pass_pass2)||drupalgap_form_set_error("current_pass","You must enter your current password to change your password."):empty(b.values.pass_pass1)||empty(b.values.pass_pass2)||b.values.pass_pass1==b.values.pass_pass2||drupalgap_form_set_error("pass_pass1","Passwords do not match.")}catch(c){console.log("user_profile_form_validate - "+c)}}
...
function user_pass_form(a,b){try{return a.elements.name={type:"textfield",title:"Username or e-mail address",required:!0,attributes:{onkeypress:"drupalgap_form_onkeypress('"+a.id+"')"}},a.elements.submit={type:"submit",value:"E-mail new password"},a}catch(c){console.log("user_pass_form - "+c)}}
function user_pass_form_submit(a,b){try{user_request_new_password(b.values.name,{success:function(a){a[0]?drupalgap_set_message("Further instructions have been sent to your e-mail address."):drupalgap_set_message("There was a problem sending an e-mail to your address.","warning");drupalgap_goto("user/login")}})}catch(c){console.log("user_pass_form_submit - "+c)}}var _taxonomy_term_reference_terms={};
