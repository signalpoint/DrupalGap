...
function date(a,b){try{var c=null;b?c=new Date(b):(c=new Date,c.getTime());for(var d="",e=0;e<a.length;e++){var f=a.charAt(e);switch(f){case "d":var g=""+c.getDate();1==g.length&&(g="0"+g);d+=g;break;case "D":g=c.getDay();switch(g){case 0:d+="Sun";break;case 1:d+="Mon";break;case 2:d+="Tue";break;case 3:d+="Wed";break;case 4:d+="Thu";break;case 5:d+="Fri";break;case 6:d+="Sat"}break;case "j":d+=c.getDate();break;case "l":g=c.getDay();switch(g){case 0:d+="Sunday";break;case 1:d+="Monday";break;case 2:d+=
"Tuesday";break;case 3:d+="Wednesday";break;case 4:d+="Thursday";break;case 5:d+="Friday";break;case 6:d+="Saturday"}break;case "F":switch(c.getMonth()){case 0:d+="January";break;case 1:d+="February";break;case 2:d+="March";break;case 3:d+="April";break;case 4:d+="May";break;case 5:d+="June";break;case 6:d+="July";break;case 7:d+="August";break;case 8:d+="September";break;case 9:d+="October";break;case 10:d+="November";break;case 11:d+="December"}break;case "m":var h=""+(c.getMonth()+1);1==h.length&&
(h="0"+h);d+=h;break;case "Y":d+=c.getFullYear();break;case "H":var k=""+c.getHours();1==k.length&&(k="0"+k);d+=k;break;case "i":var l=""+c.getMinutes();1==l.length&&(l="0"+l);d+=l;break;default:d+=f}}return d}catch(m){console.log("date - "+m)}}
...
function function_exists(a){try{return"function"==eval("typeof "+a)}catch(b){alert("function_exists - "+b)}}function http_status_code_title(a){try{var b="";switch(a){case 200:b="OK";break;case 401:b="Unauthorized";break;case 404:b="Not Found";break;case 406:b="Not Acceptable";break;case 500:b="Internal Server Error"}return b}catch(c){console.log("http_status_code_title - "+c)}}
function in_array(a,b){try{if("undefined"===typeof b)return!1;if("string"===typeof a)return-1<b.indexOf(a);for(var c=!1,d=0;d<b.length;d++)if(b[d]==a){c=!0;break}return c}catch(e){console.log("in_array - "+e)}}function is_int(a){"string"===typeof a&&(a=parseInt(a));return"number"===typeof a&&0==a%1}function language_default(){try{return Drupal.settings.language_default&&""!=Drupal.settings.language_default?Drupal.settings.language_default:"und"}catch(a){console.log("language_default - "+a)}}
function module_exists(a){try{var b=!1;"undefined"!==typeof Drupal.modules.core[a]?b=!0:"undefined"!==typeof Drupal.modules.contrib[a]?b=!0:"undefined"!==typeof Drupal.modules.custom[a]&&(b=!0);return b}catch(c){console.log("module_exists - "+c)}}function time(){return Math.floor(new Date/1E3)}function ucfirst(a){a+="";return a.charAt(0).toUpperCase()+a.substr(1)}
